...
class PeerNode():
    ...
    def calculate_pagerank(self):
        self.logger.info("PeerNode_ks::calculate_pagerank")
    ...
    def send_pagerank_message(self, new_pagerank_id, new_pagerank_values, subgraph_id):
        self.logger.info("PeerNode_ks::send_pagerank_message")
    ...
    def update_page_graph(self, node_to_update, new_page_rank):
        self.logger.debug(f"PeerNode_ks::update_page_graph - updating {node_to_update}, and all its inward links, with {new_page_rank}")
